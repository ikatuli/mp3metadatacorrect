...
Если в названии файла присутсвуют несколько тире, то в качестве разделителя будет выбран последний.

Для того, чтобы применить скрипт ко всем mp3 файлам в текущей директории, выполните следующую команду:
```
